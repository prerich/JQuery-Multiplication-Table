/* 
    ...
    added features to compare min and max and check if its an integer
    because digit does not take negative numbers
...
$(document).ready(function(){
    $("#form").validate({
        //setting the rules for a valid input
        //all inputs are required
        // all are under the same range
